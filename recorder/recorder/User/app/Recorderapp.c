...
static char tempstr[1024]={"rec001.wav"};
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreateRecorder[] = {
  ...
  { BUTTON_CreateIndirect,   "Record",     GUI_ID_BUTTON0,   87, 230, 58, 58,  0, 0x0,  0 },
  //{ BUTTON_CreateIndirect,   "Replay",     GUI_ID_BUTTON1,   135, 190, 58, 58, 0, 0x0,  0 },
	...
	{  MULTIEDIT_CreateIndirect,     "Question",       GUI_ID_TEXT0,     0, 20, 240, 90, 0, 0x64, 0 },
	{ MULTIEDIT_CreateIndirect,     "Answer",       GUI_ID_TEXT1,     0, 100, 240, 120, 0, 0x64, 0 },
...
//	VS_Sine_Test();
	...
	while(Flag_ICON001)
	{
		if(RecordFlag==1)
		{
			...
			///////////////////////////////////////////////////////////
			//freopen("USART1", "r", stdin);
			//fflush(stdout); // ???????,???????????
			scanf("%[^\n]\n%[^\n]", str1, str2);
			//sprintf(tempstr,"nihao");
			//tempstr[5] = '\0';
			
			TEXT_SetText(WM_GetDialogItem(hWin, GUI_ID_TEXT0),str1);
			
			//scanf("%s", tempstr);
			//fflush(stdout);
			//scanf("%s", str);
			//sprintf(tempstr,"saddd");
			//tempstr[5] = '\0';
			//insertNewlines(str2);
			TEXT_SetText(WM_GetDialogItem(hWin, GUI_ID_TEXT1),str2);		
