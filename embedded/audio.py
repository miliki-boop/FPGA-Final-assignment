...
class Audio_Recog(object):
    def __init__(self, audiofile, output_path='./audio_recog/1.txt'):
        self.audiofile = audiofile
        self.output_path = output_path
        self.wsParam = Ws_Param(APPID='db7317cf', APISecret='NjY0YzAwY2I0NGQ2YjBhMjU1MDQwNTI2',
                        APIKey='5fe6a13fb47508d454d6e55049aaf276',
